...
const ShowTeachers = () => {
    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', margin: '20px 0' }}>
            <Paper sx={{ width: '100%', maxWidth: 800, overflow: 'hidden', padding: '16px', boxShadow: 3 }}>
                <TableContainer>
